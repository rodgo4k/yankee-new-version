...
import {
  CareersPrinciplesScene,
  CareersRolesScene,
} from "@/components/home/CareersFeatureScenes";
            ...
            <div className="lg:col-span-6">
              <div className="relative mx-auto max-w-[420px] pb-10 md:pb-12">
                ...
                >
                  ...
                  <p className="mt-4 text-center text-[13px] text-foreground/70 lowercase">
        ...
        <div className="relative max-w-[900px] mx-auto px-5 md:px-6">
          <AnimatedSection className="text-center mb-12 md:mb-14">
            ...
            <p className="mt-4 text-[15px] text-muted-foreground lowercase">
              click a role to email us. no forms, no ats maze.
            </p>
          </AnimatedSection>
