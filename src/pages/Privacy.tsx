  ...
  <Layout>
    <article className="max-w-[720px] mx-auto px-5 md:px-6 pt-10 md:pt-14 pb-20 md:pb-28">
      ...
      <div className="mt-10 space-y-6 text-[15px] text-foreground/85 leading-[1.7]">
        <p>
          Yankee takes your privacy seriously. This policy explains what information we collect, why
          we collect it, how we use it, and what choices you have. It applies to the Yankee website,
          the Yankee iOS app, and any related services operated by Yankee LLC, a Foretheist product
        ...
        <section className="space-y-4 pt-4">
          ...
          <p>
            When we collect information that can identify you, we tell you what we are asking for
            and why. That usually happens when you create an account, update your profile, post
          ...
          <p>
            If we introduce a new use of personal data that is not covered by this policy, we ask for
            your permission before using your data for that purpose, unless the law allows us to
            proceed without it.
          </p>
        </section>
        ...
        <section className="space-y-4 pt-2">
          ...
          <p>
            When you post or share on Yankee, we store that content so we can show it to the people
            you intend. This can include posts, comments, reactions, photos, videos, captions,
            community content, memory items, and drafts. Visibility depends on the audience you
            choose (for example public, followers, a community, or a private circle).
          </p>
          <p>
          ...
          <p>
            ...
            basic function. Optional cookies, if any, are presented so you can accept or refuse
            them.
          </p>
        </section>
