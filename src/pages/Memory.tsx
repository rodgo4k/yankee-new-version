...
const faqs = [
  ...
  },
  {
    ...
    a: "No. Decryption keys live on your devices. Even under a subpoena, we would only be able to hand over ciphertext blobs.",
  },
  {
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          <AnimatedSection className="lg:col-span-5 text-center lg:text-left">
            ...
            <h2 className="mt-3 text-3xl sm:text-4xl md:text-5xl font-semibold text-foreground tracking-tight leading-[1.02] lowercase">
              private,{" "}
              <span className="font-serif-display italic font-medium">not fragile</span>
            </h2>
            <p className="mt-5 text-[15px] md:text-[16px] text-muted-foreground leading-relaxed lowercase max-w-md mx-auto lg:mx-0">
              memory lives on your device first, encrypted in backup, never used to train a model, and erasable anytime.
            </p>
