...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. You choose all followers, a specific Crowd, or close friends before you ship. The audience is always visible in the composer so there are no surprises.",
  },
  {
  ...
  {
    q: "Does my post get reshuffled later?",
