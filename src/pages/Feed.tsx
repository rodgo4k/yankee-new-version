        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 order-1 lg:order-2 relative">
            <div className="relative mx-auto max-w-[320px] lg:max-w-[360px]">
              ...
              >
                <div className="rounded-2xl rounded-bl-md border-2 border-foreground bg-[#E8E6E1] px-3.5 py-2.5 text-[12px] md:text-[13px] leading-snug lowercase shadow-[4px_4px_0_0_hsl(var(--foreground))]">
              ...
              >
                <div className="rounded-2xl rounded-br-md bg-[#5B9CFF] px-3.5 py-2.5 text-[12px] md:text-[13px] leading-snug text-white lowercase shadow-[4px_4px_0_0_hsl(var(--foreground))]">
