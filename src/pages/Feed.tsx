...
const feedBlocks = [
  {
    ...
    title: (
      <>
        surfaces the <span className="font-serif-display italic font-medium">right posts</span>
      </>
    ),
  ...
  },
  {
    ...
    title: (
      <>
        tells you when <span className="font-serif-display italic font-medium">you&apos;re done</span>
      </>
    ),
  ...
  },
  {
    ...
    title: (
      <>
        learns your <span className="font-serif-display italic font-medium">taste</span>
      </>
    ),
...
const principles = [
  {
    ...
    text: "newest at the top. no reshuffling, no surprise resurfacing.",
  },
  {
    icon: Users,
  ...
  },
  {
    icon: CheckCircle2,
    title: "a real ending",
    text: "when you're caught up, yankee says so and steps aside.",
  },
];
      ...
      <div className="relative max-w-[1200px] mx-auto px-5 md:px-6">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          <div className="lg:col-span-6 order-2 lg:order-1 text-center lg:text-left">
            ...
            >
              <PromoPill tag="feed" text="chronological, finite, honest" to="/features" />
            </motion.div>
            ...
            >
              a feed that{" "}
              <span className="font-serif-display italic font-medium">respects your time.</span>
            </motion.h1>
            ...
            >
              every post from the people you follow, in the order they shared it. no ranking. a clear ending when you&apos;re done.
            </motion.p>
          ...
          <div className="lg:col-span-6 order-1 lg:order-2 relative">
            <div className="relative mx-auto max-w-[320px] lg:max-w-[360px]">
              ...
              <motion.div
                ...
                className="absolute -left-4 top-[18%] z-20 max-w-[70%]"
              >
                <div className="rounded-2xl rounded-bl-md border-2 border-foreground bg-folk-bubble-soft px-3.5 py-2.5 text-[12px] md:text-[13px] leading-snug lowercase shadow-[4px_4px_0_0_hsl(var(--foreground))]">
              ...
              <motion.div
                ...
                className="absolute -right-2 bottom-[22%] z-20 max-w-[75%]"
              >
                <div className="rounded-2xl rounded-br-md bg-folk-bubble px-3.5 py-2.5 text-[12px] md:text-[13px] leading-snug text-folk-bubble-foreground lowercase shadow-[4px_4px_0_0_hsl(var(--foreground))]">
      ...
      <div className="max-w-[900px] mx-auto px-5 md:px-6">
        <AnimatedSection className="text-center">
          ...
          <p className="mt-4 text-[15px] text-muted-foreground lowercase">
            short answers about how the chronological feed actually works.
          </p>
        </AnimatedSection>
        ...
        <AnimatedSection>
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              >
                ready for a{" "}
                <span className="font-serif-display italic font-medium">quieter feed?</span>
              </motion.h2>
              <motion.p
                initial={{ opacity: 0, y: 14 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              <div className="relative mx-auto max-w-md">
                ...
                >
                  ...
                  <div className="mt-3 flex items-center justify-between gap-2">
                    <span className="text-[12px] lowercase text-foreground/70">just posted · trail photos</span>
