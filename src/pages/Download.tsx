        ...
        <AnimatedSection>
          <div className="rounded-[1.75rem] border-2 border-foreground bg-card overflow-hidden shadow-[6px_6px_0_0_hsl(var(--foreground))]">
            <div className="grid sm:grid-cols-12">
              <div className="sm:col-span-4 border-b-2 sm:border-b-0 sm:border-r-2 border-foreground bg-[#F3F1EC] p-7 md:p-8 flex flex-col items-center justify-center text-center">
