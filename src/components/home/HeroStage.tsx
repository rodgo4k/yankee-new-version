...
const HeroStage = () => {
  ...
  useEffect(() => {
    ...
    // Defer the heavy carousel on iPhone so chrome/nav paint first.
  ...
  return (
    ...
    >
      <div className="relative h-[320px] sm:h-[380px] md:h-[440px] max-md:!h-[360px] overflow-visible">
        <div className="absolute inset-0 z-10">{ready ? <RadialCardsSlider /> : null}</div>
      </div>

      <div className="relative z-20 mt-6 sm:mt-7 md:mt-4 max-md:!mt-12 flex flex-col items-center gap-3">
        <BeamIosCta />
